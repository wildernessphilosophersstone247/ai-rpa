...
- Exposed the Python REPL client (`clients/python/aria_tree.py`) that talks to `/api/execute`, `/health`, `/screenshot`, `/api/apps`, and `/api/stop`.
...
- `aria_tree.py --apps` lists all launcher-ready packages returned by `/api/apps`.
